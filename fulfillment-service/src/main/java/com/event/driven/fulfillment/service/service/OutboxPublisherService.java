...
import com.event.driven.fulfillment.service.entity.OutboxEvent;
import com.event.driven.fulfillment.service.kafka.FulfillmentKafkaPublisher;
...
public class OutboxPublisherService {
    ...
    private final FulfillmentKafkaPublisher fulfillmentKafkaPublisher;

    @Autowired
    public OutboxPublisherService(OutboxEventService outboxEventService, 
                                    FulfillmentKafkaPublisher fulfillmentKafkaPublisher) {
        this.outboxEventService = outboxEventService;
        this.fulfillmentKafkaPublisher = fulfillmentKafkaPublisher;
    }
    ...
    private void publishEvent(OutboxEvent outboxEvent) {
        try {
            fulfillmentKafkaPublisher.publish(outboxEvent);
