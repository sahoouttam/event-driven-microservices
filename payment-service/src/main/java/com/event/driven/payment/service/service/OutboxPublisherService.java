...
import com.event.driven.payment.service.kafka.PaymentKafkaPublisher;
...
public class OutboxPublisherService {
    ...
    public OutboxPublisherService(OutboxEventService outboxEventService, 
                                    PaymentKafkaPublisher paymentKafkaPublisher) {
        this.outboxEventService = outboxEventService;
        this.paymentKafkaPublisher = paymentKafkaPublisher;
    }
    ...
    private void publishEvent(OutboxEvent outboxEvent) {
        try {
            paymentKafkaPublisher.publish(outboxEvent);
